...
@pytest.mark.parametrize("input_score,input_method,score", valid_test_data)
...
invalid_test_data = [
    ...
    ("dd", InputMethod.THREEDARTS),
    ("181", InputMethod.ROUND),
    ("179", InputMethod.ROUND),
]


@pytest.mark.parametrize("input_score,input_method", invalid_test_data)
